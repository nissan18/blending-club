...
columns = [
    ...
    },
    {
        "name": "id",
        "dtype": "int64",
        "feature": "don't parse"  # don't need this for real model, maybe add to test for noise
    },
    {
        "name": "il_util",
        "dtype": "float64",
    ...
    },
    {
        "name": "int_rate",
        "dtype": str,
        "feature": "percent"  #     df["f_int_rate"] = df["int_rate"].apply(lambda val : np.float64(val.strip(" %")))
    ...
    },
    {
        "name": "policy_code",
        "dtype": "int64",
        "feature": "one-hot encoding"  # TODO: "publicly available policy_code=1, new products not publicly available policy_code=2"
    },
    {
        "name": "pub_rec",
        "dtype": "float64",
    ...
    },
    {
        "name": "revol_util",
        "dtype": str,
        "feature": "percentage"  # buildPercentageFeature(df, "revol_util")
    },
    {
    ...
    },
    {
        "name": "url",
        "dtype": str,
        "feature": "don't parse"  # TODO: url -- check probably always https://lendingclub.com/browse/loanDetail.action?loan_id=<id>
    },
    {
    ...
    },
    {
        ...
        "dtype": str,
        "feature": "one-hot encoding"  # WARNING: verified_status_joint SHOULD BE verification_status_joint
    },
    {
        "name": "zip_code",
        "dtype": str,
